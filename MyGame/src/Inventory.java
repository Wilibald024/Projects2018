...
//        System.out.println("Working");
    ...
    public void render(Graphics g) {
        ...
        g.drawImage(Assets.invenotryScreen, invX, invY, invWidth, invHeight, null);

        //Text.drawString(g, "> Rock Item <", invListCenterX, invListCenterY, true, Color.RED, Assets.font28);
